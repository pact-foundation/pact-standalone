...
Ruby is not required on the host platform, Ruby 3.3.10 is provided in the distributable.

| OS     | Ruby      | Architecture   | Supported |
| -------| -------   | ------------   | --------- |
| MacOS  | 3.3.10     | x86_64         | ✅        |
| MacOS  | 3.3.10     | aarch64 (arm64)| ✅        |
| Linux  | 3.3.10     | x86_64         | ✅        |
| Linux  | 3.3.10     | aarch64 (arm64)| ✅        |
| Windows| 3.3.10     | x86_64         | ✅        |
| Windows| 3.3.10     | aarch64 (arm64)| 🚧        |
